...
public interface TripRepository extends JpaRepository<Trip, Long> {
    @Query("SELECT DISTINCT t FROM Trip t LEFT JOIN FETCH t.items LEFT JOIN FETCH t.participants p WHERE t.user.id = :userId OR p.id = :userId ORDER BY t.departureDate DESC")
